...
st.sidebar.write("[Click here](https://share.streamlit.io/mesmith027/streamlit_webapps/main/MC_pi/streamlit_app.py) to get the source code.")
st.sidebar.markdown("""### <br>
## :copyright: Abhikriti Moti <br> Email: <a href="mailto:hello@streamlit.io">abhikriti.12007073@lpu.in </a>""", unsafe_allow_html=True)
